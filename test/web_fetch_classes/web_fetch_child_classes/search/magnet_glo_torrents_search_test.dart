...
void main() {
  ...
  group('GloTorrents search unit tests', () {
    ...
    test('Run myConstructURI()', () {
      const expectedResult =
          'https://glodls.online/search_results.php?search=new%20query&sort=seeders&order=desc&page=0';
    ...
    test('Run myConvertWebTextToTraversableTree() for 0 results', () {
      ...
      final actualOutput = QueryGloTorrentsSearch(
        criteria,
  ...
  group('GloTorrentsSearchConverter integration tests', () {
    ...
    test('myConvertTreeToOutputType() errors', () {
      ...
      // Invoke the functionality and collect results.
      final actualResult = gloTorrentsSearch.myConvertTreeToOutputType(
        'wrongData',
      );
