...
{instance def_uniqueId -> uniqueId: is different
  Expected: "def_uniqueId"
    ...
    test('MovieResultDTOListFuzzyMatcher different text', () {
      ...
      final actualResult = mismatchDescription.toString();
      // Uncomment the line below to update the expected result.
      // writeRawTestData(actualResult, suffix: '_fuzzy.output');

      // Test the actual result against the expected result.
      final expectedText = rawTestData(suffix: '_fuzzy.output');
      expect(actualResult, expectedText);
    });
    // Test list matcher error string.
    test('MovieResultDTOListFuzzyMatcher different number', () {
      ...
      final actualResult = mismatchDescription.toString();
      // Uncomment the line below to update the expected result.
      // writeRawTestData(actualResult, suffix: '_fuzzy_number.output');

      // Test the actual result against the expected result.
      final expectedText = rawTestData(suffix: '_fuzzy_number.output');
      expect(actualResult, expectedText);
    });
  });
