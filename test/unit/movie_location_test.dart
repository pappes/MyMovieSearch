...
Future<void> main() async {
  group('Movie location test data', () {
    ...
    test('default backup data', () async {
    ...
    test('getLocationsForMovie', () async {
      await MovieLocation().init();
      ...
      final actualOutput = MovieLocation().getLocationsForMovie(
        contents.uniqueId,
      );
      final expectedOutput = [address];
      expect(actualOutput, expectedOutput);
    });
    test('getMoviesAtLocation', () async {
      await MovieLocation().init();
      const contents = StackerContents(
        uniqueId: 'tt111111111',
        titleName: 'Batman',
    ...
    test('usedLocations', () async {
      ...
      for (final i in range(2, 150)) {
        MovieLocation().storeMovieAtLocation(
          contents,
          StackerAddress(libNum: '007', location: i.toString().padLeft(3, '0')),
        );
      }
