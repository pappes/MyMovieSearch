...
import 'package:my_movie_search/movies/web_data_providers/imdb_json/imdb_cast_converter.dart';
...
class QueryIMDBCastDetails
  ...
  Future<Iterable<MovieResultDTO>> myConvertTreeToOutputType(
    ...
    if (map is Map) {
      return ImdbCastConverter().dtoFromCompleteJsonMap(map, .imdbCast);
    }
  ...
  MovieResultDTO myYieldError(String message) =>
      MovieResultDTO().error('[QueryIMDBCastDetails] $message', .imdb);
}
