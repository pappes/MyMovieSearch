...
''',
  r'''
{"uniqueId":"tt0185014","bestSource":"DataSourceType.brave","title":"Wonder Boys ","type":"MovieContentType.movie","year":"2000","yearRange":"2000","imageUrl":"https://m.media-amazon.com/images/M/MV5BZGFlZDI5OGMtMmVhMS00NTQxLTgzZmEtZDJlMGVjNWViZThmXkEyXkFqcGdeQXVyMTAwMzUyOTc@._V1_UY1200_CR91,0,630,1200_AL_.jpg","sources":{"DataSourceType.brave":"tt0185014"}}
''',
  r'''
{"uniqueId":"tt0451279","bestSource":"DataSourceType.brave","title":"Wonder Woman ","type":"MovieContentType.movie","year":"2017","yearRange":"2017","imageUrl":"https://m.media-amazon.com/images/M/MV5BMTYzODQzYjQtNTczNC00MzZhLTg1ZWYtZDUxYmQ3ZTY4NzA1XkEyXkFqcGdeQXVyODE5NzE3OTE@._V1_UY1200_CR90,0,630,1200_AL_.jpg","sources":{"DataSourceType.brave":"tt0451279"}}
''',
  r'''
{"uniqueId":"tt13276386","bestSource":"DataSourceType.brave","title":"Shawn Mendes: In Wonder ","type":"MovieContentType.movie","year":"2020","yearRange":"2020","imageUrl":"https://m.media-amazon.com/images/M/MV5BNDRkMGM5YTQtOGMzZS00ZGJiLTg5YWMtYjg4NTcyZTk0MzAzXkEyXkFqcGdeQXVyMTI0OTAwOTgy._V1_UY1200_CR90,0,630,1200_AL_.jpg","sources":{"DataSourceType.brave":"tt13276386"}}
''',
  r'''
{"uniqueId":"tt1595656","bestSource":"DataSourceType.brave","title":"To the Wonder ","type":"MovieContentType.series","year":"2012","yearRange":"2012-","imageUrl":"https://m.media-amazon.com/images/M/MV5BMTAwNzk1NjM2ODZeQTJeQWpwZ15BbWU3MDE1MjQwMjk@._V1_UY1200_CR90,0,630,1200_AL_.jpg","sources":{"DataSourceType.brave":"tt1595656"}}
''',
  r'''
{"uniqueId":"tt1740828","bestSource":"DataSourceType.brave","title":"Wonder Woman ","type":"MovieContentType.movie","year":"2011","yearRange":"2011","imageUrl":"https://m.media-amazon.com/images/M/MV5BMjA0MzYzNzY3OV5BMl5BanBnXkFtZTcwMzM4ODM4NA@@._V1_UX630_CR0,0,630,1200_AL_.jpg","sources":{"DataSourceType.brave":"tt1740828"}}
''',
  r'''
{"uniqueId":"tt2543472","bestSource":"DataSourceType.brave","title":"Wonderful movie with real long title that google truncates ","type":"MovieContentType.series","year":"2021","yearRange":"2021-","imageUrl":"https://m.media-amazon.com/images/M/MV5BYjFhOWY0OTgtNDkzMC00YWJkLTk1NGEtYWUxNjhmMmQ5ZjYyXkEyXkFqcGdeQXVyMjMxOTE0ODA@._V1_UY1200_CR74,0,630,1200_AL_.jpg","sources":{"DataSourceType.brave":"tt2543472"}}
''',
  r'''
...
{
  "uniqueId": "-1", 
  "title": "Unknown Brave error - potential API change! type 'Null' is not a subtype of type 'Map<dynamic, dynamic>' in type cast {error: {code: 400, message: Request contains an invalid argument., errors: [{message: Request contains an invalid argument., domain: global, reason: badRequest}], status: INVALID_ARGUMENT}}"
}
'''
]);
...
const jsonSampleFull = ' $braveMoviesJsonSearchPrefix '
    '$braveMoviesJsonSearchInner $braveMoviesJsonSearchSuffix';

Future<Stream<String>> streamBraveMoviesJsonOfflineData(_) =>
    Future.value(Stream.value(jsonSampleFull));

const braveMoviesJsonSearchSuffix = '''
  ]
}
''';
const braveMoviesJsonSearchPrefix = '''
    {
...
const braveMoviesJsonSearchInner = r'''
    {
      "kind": "customsearch#result",
      "title": "Wonderful movie with real long title that google truncates (2017... - IMDb",
        ...
        "metatags": [
          {
            ...
            "og:type": "video.movie",
            "og:site_name": "IMDb",
            "og:title": "Wonderful movie with real long title that google truncates (TV Series 2021– ) - IMDb",
            "pageid": "tt2543472",
            "title": "Wonderful movie with real long title that google truncates (TV Series 2021– ) - IMDb",
