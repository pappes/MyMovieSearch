...
/// A [JsonPCodec] encodes JSON objects by wrapping it in a Jvascript function name
/// and decodes strings by removing the javascript function wrapper.
///
/// Examples:
///
///     var encoded = json.encode('{ "a": null }'"); // becomes 'function({ "a": null })'
///     var encoded = json.decode('function({ "a": null })'"); // becomes '{ "a": null }'
