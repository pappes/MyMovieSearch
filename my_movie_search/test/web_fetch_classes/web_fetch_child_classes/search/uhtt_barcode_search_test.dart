...
////////////////////////////////////////////////////////////////////////////////
  ...
  group('UhttBarcodeSearchConverter integration tests', () {
    ...
    test('Run myConvertTreeToOutputType()', () async {
      final expectedValue = expectedDTOList;
      final UhttBarcodeSearch = QueryUhttBarcodeSearch(criteria);
      final actualResult = <MovieResultDTO>[];

      // Invoke the functionality and collect results.
      for (final map in intermediateMapList) {
        actualResult.addAll(
          await UhttBarcodeSearch.myConvertTreeToOutputType(map),
        );
      }
    ...
    test('myConvertTreeToOutputType() errors', () async {
      ...
      // Invoke the functionality and collect results.
      final actualResult = UhttBarcodeSearch.myConvertTreeToOutputType('map');
...
////////////////////////////////////////////////////////////////////////////////
  ...
  group('UhttBarcode search query', () {
    ...
    test('Run readList()', () async {
      ...
      // Invoke the functionality.
      await UhttBarcodeSearch.readList(
        source: streamHtmlOfflineData,
      ).then((values) => queryResult.addAll(values)).onError(
            // ignore: avoid_print
