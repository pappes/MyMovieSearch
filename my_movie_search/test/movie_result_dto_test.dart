...
void main() {
  group('DTOCompare', () {
    ...
    test('MovieResultDTOListMatcher different', () {
      const expectedError = '{instance(2) -> uniqueId: is different\n'
          '  Expected: "xyz"\n'
          '  Actual: "def_uniqueId"\n'
          '}';
      final list1 = <MovieResultDTO>[
      ...
      list2.last.uniqueId = 'xyz';

      final matcher = MovieResultDTOListMatcher(list1);

      final Description mismatchDescription = StringDescription();
      final Map<dynamic, dynamic> matchState = {};
      const bool verbose = false;
      matcher.matches(list2, matchState);
      matcher.describeMismatch(list1, mismatchDescription, matchState, verbose);
  ...
  group('MovieResultDTOinit', () {
    ...
    test('full_DTO_json', () {
      ...
      final initialisedDTO = MovieResultDTO().init(
        ...
        aListRanking: dto.aListRanking.toString(),
